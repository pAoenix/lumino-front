...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.2.121,198.18.0.1";
  const port = "8090";
  const id = "mp-weixin_AbNXM_";
...
const pages = [
  ...
  {
    path: "pages/account/add-count",
    style: {
      navigationBarTitleText: "账单金额"
    }
  },
  {
    path: "pages/account/add-bill",
    style: {
      navigationBarTitleText: "账单详情"
    }
  },
  {
    path: "pages/account/account-details",
    style: {
      navigationBarTitleText: "账单详情"
    }
  },
  {
    path: "pages/account/add-account-book",
    style: {
      navigationBarTitleText: "新建账本"
    }
  },
  {
    path: "pages/account/participants",
    style: {
      navigationBarTitleText: "新建账本"
    }
  },
  {
    path: "pages/find/reply",
    style: {
  ...
  {
    path: "pages/my/add-icon",
    style: {
      navigationBarTitleText: ""
    }
  },
  {
    path: "pages/index/add-transaction",
    style: {
      navigationBarTitleText: "简简单单记个账"
    }
  }
];
const tabBar = {
  ...
  list: [
    {
      ...
      selectedIconPath: "static/detailsHL.png",
      text: "账本"
    },
    {
      pagePath: "pages/chart/index",
      iconPath: "static/chart.png",
      selectedIconPath: "static/chartHL.png",
      text: "图表"
    },
    {
      pagePath: "pages/index/index",
      iconPath: "static/add.png",
      selectedIconPath: "static/addHL.png",
      text: "记账"
    },
    {
      pagePath: "pages/find/index",
      iconPath: "static/find.png",
      selectedIconPath: "static/findHL.png",
      text: "发现"
    },
    {
...
const globalStyle = {
  ...
  navigationBarTitleText: "记个账单",
  navigationBarBackgroundColor: "#55c9c9",
...
const S$1 = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I(""), C = I("[]") || [];
let O = "";
try {
  O = "__UNI__186CB80";
} catch (e2) {
...
function M$1(e2, t2) {
  D$1[e2] || (D$1[e2] = {}), g(t2) && Object.keys(t2).forEach((n2) => {
    N.indexOf(n2) > -1 && function(e3, t3, n3) {
      let s2 = D$1[e3][t3];
      s2 || (s2 = D$1[e3][t3] = []), -1 === s2.indexOf(n3) && m(n3) && s2.push(n3);
    }(e2, n2, t2[n2]);
  });
}
function q(e2, t2) {
...
const $ = R("_globalUniCloudListener"), B = "response", W$1 = "needLogin", H$1 = "refreshToken", J = "clientdb", z = "cloudfunction", V = "cloudobject";
function G(e2) {
  return $[e2] || ($[e2] = []), $[e2];
}
function Y$1(e2, t2) {
...
class os {
  ...
  _send(e2, t2) {
    ...
    if (s2.$db.push({ $method: e2, $param: rs(t2) }), S$1) {
...
详细信息：${s4}`), r3(i3);
      ...
      e3.result.errCode = e3.result.errCode || e3.result.code, e3.result.errMsg = e3.result.errMsg || e3.result.message, s3 && c3 && (ae({ token: s3, tokenExpired: c3 }), this._callbackAuth("refreshToken", [{ token: s3, tokenExpired: c3 }]), this._callback("refreshToken", [{ token: s3, tokenExpired: c3 }]), X(H$1, { token: s3, tokenExpired: c3 }));
...
function Rs() {
  !function() {
    const e3 = _s(), { abortLoginPageJump: t2, autoToLoginPage: n2 } = Ls$1({ url: e3 });
    ...
    s2 && function(e3 = {}) {
      ...
      te().then(() => {
        ...
        if (n3 && Os({ redirect: n3 }))
          return t3.length > 0 ? X(W$1, Object.assign({ uniIdRedirectUrl: n3 }, e3)) : void (Ss && Es({ api: "navigateTo", redirect: n3 }));
      });
    }(n2);
  });
}
  ...
  return function(t2, n2 = {}) {
    ...
    return new Proxy({}, { get(s3, c2) {
      ...
      return function({ fn: e3, interceptorName: t3, getCallbackArgs: n3 } = {}) {
        ...
        if (a2 && index.hideLoading(), y2 && y2.token && y2.tokenExpired && (ae(y2), X(H$1, { ...y2 })), g2) {
          let e3 = m2;
          if (p2 && o2) {
...
(() => {
  ...
  if (Object.assign(tr, { get mixinDatacom() {
    return Bs(tr);
  } }), Ns(tr), tr.addInterceptor = M$1, tr.removeInterceptor = q, tr.interceptObject = j, "web" === A)
    ;
})();
var nr = tr;
